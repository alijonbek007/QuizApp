...
import 'package:imtihon/screens/users_login/user2_login.dart';
    ...
    return [
      ...
      TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintText: "Birinchi o'yinchi nomingizni kiriting...",
          labelText: "User-1",
        ),
        validator: (String? v) {
          if (v!.length < 4) {
        ...
        onPressed: () {
          if (_formKey.currentState!.validate() && _color != null) {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => SecondUserLogin(
                  color: _color,
